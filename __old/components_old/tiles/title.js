        ...
        <div style={styles.inner}>
          ...
          <ul style={styles.list}>
            <li style={styles.firstListItem}>
              <a href="http://www.linkedin.com/in/jakobheuser" title="Resume on LinkedIn">
                <span className="x-fa x-fa-linkedin"></span>
              </a>
            </li>
            <li style={styles.listItem}>
              <a href="https://www.github.com/Jakobo" title="Code on GitHub">
                <span className="x-fa x-fa-github"></span>
              </a>
            </li>
            <li style={styles.listItem}>
              <a href="https://www.medium.com/@jakob" title="Writing on Medium">
                <span className="x-fa x-fa-medium"></span>
              </a>
            </li>
            <li style={styles.listItem}>
              <a href="https://www.twitter.com/@jakobo" title="Quips on Twitter">
                <span className="x-fa x-fa-twitter"></span>
              </a>
            </li>
            <li style={styles.listItem}>
              <a href="https://www.500px.com/jakobo" title="Photos on 500px">
                <span className="x-fa x-fa-camera"></span>
              </a>
            </li>
            <li style={styles.listItem}>
              <a href="https://www.pinterest.com/jakobo/" title="Neat Things on Pinterest">
